report 50102 "Credit Note_WithoutVAT"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports\Credit Note_WithoutVAT\Credit Note_WithoutVAT.rdl';
    Caption = 'Credit Note Without VAT';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Cr.Memo Header")
        {
            ...
            column(CompanyCountryNameG; CompanyCountryNameG)
            {
            ...
            begin
                ...
                PaymentTermsL.SetRange(Code, "Sales Header"."Payment Terms Code");
                if PaymentTermsL.FindFirst() then
                    PaymentDescriptionTextG := PaymentTermsL.Description;
            ...
            begin
                ...
                CountryG.SetRange(Code, CompanyInfo."Country/Region Code");
                if CountryG.FindFirst() then
                    CompanyCountryNameG := CountryG.Name;
