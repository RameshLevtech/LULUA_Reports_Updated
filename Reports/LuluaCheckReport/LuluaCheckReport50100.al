report 50100 "Lulua Check"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Reports/LuluaCheckReport/LuluaCheck.rdl';
    Caption = 'Check';
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(Pay_to_the_order_of; "Pay to the order of") { }
                            ...
                            with GenJnlLine do begin
                                ...
                                if FoundLast and AddedRemainingAmount then begin
                                    ...
                                    if StrLen(Format(Decimals)) < StrLen(Format(Currency."Amount Rounding Precision")) then
                                        ...
                                        CheckAmountText := Format(CheckLedgEntryAmount, 0, 0);
                                    //Ramesh
                                    FormatNoText(DescriptionLine, Amount, BankAcc2."Currency Code");
                                    VoidText := '';
                                end else begin
