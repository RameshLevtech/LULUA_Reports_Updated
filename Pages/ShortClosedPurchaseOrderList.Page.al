page 50003 "ShortClosed Purchase Order"
{
    ApplicationArea = Basic, Suite;
    Caption = 'ShortClosed Purchase Orders';
    ...
    SourceTableView = WHERE("Document Type" = CONST(Order), "Short Close" = const(true), "Status" = FILTER(Released));
    UsageCategory = Lists;
